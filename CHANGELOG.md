...
- SQLite history, long-term rollups, per-app exclusions, and merge-safe `.pcw` backups.
...
- Cinematic Yearly Wrapped scenes and local portrait/story share-card exports.
...
[1.0.0]: https://github.com/TheAgencyMGE/pc-wrapped/releases/tag/v1.0.0
